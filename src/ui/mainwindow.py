...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_6 = QtWidgets.QLabel(self.visualConfWidget)
        self.label_6.setMaximumSize(QtCore.QSize(16777215, 20))
        self.label_6.setAlignment(QtCore.Qt.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.gridLayout_10.addWidget(self.label_6, 3, 1, 1, 2)
        self.gridLayout_16 = QtWidgets.QGridLayout()
        self.gridLayout_16.setObjectName("gridLayout_16")
        self.phaseMaxValue = QtWidgets.QDoubleSpinBox(self.visualConfWidget)
        self.phaseMaxValue.setMinimumSize(QtCore.QSize(0, 30))
        self.phaseMaxValue.setMaximum(100000.0)
        self.phaseMaxValue.setObjectName("phaseMaxValue")
        self.gridLayout_16.addWidget(self.phaseMaxValue, 0, 0, 1, 1)
        self.phaseMaxMultiplier = QtWidgets.QSpinBox(self.visualConfWidget)
        self.phaseMaxMultiplier.setMinimumSize(QtCore.QSize(0, 30))
        self.phaseMaxMultiplier.setObjectName("phaseMaxMultiplier")
        self.gridLayout_16.addWidget(self.phaseMaxMultiplier, 0, 1, 1, 1)
        self.gridLayout_10.addLayout(self.gridLayout_16, 4, 2, 1, 1)
        self.gridLayout_15 = QtWidgets.QGridLayout()
        self.gridLayout_15.setObjectName("gridLayout_15")
        self.phaseMinValue = QtWidgets.QDoubleSpinBox(self.visualConfWidget)
        self.phaseMinValue.setMinimumSize(QtCore.QSize(0, 30))
        self.phaseMinValue.setMaximum(100000.0)
        self.phaseMinValue.setObjectName("phaseMinValue")
        self.gridLayout_15.addWidget(self.phaseMinValue, 0, 0, 1, 1)
        self.phaseMinMultiplier = QtWidgets.QSpinBox(self.visualConfWidget)
        self.phaseMinMultiplier.setMinimumSize(QtCore.QSize(0, 30))
        self.phaseMinMultiplier.setObjectName("phaseMinMultiplier")
        self.gridLayout_15.addWidget(self.phaseMinMultiplier, 0, 1, 1, 1)
        self.gridLayout_10.addLayout(self.gridLayout_15, 4, 1, 1, 1)
        ...
        self.amplitudeMaxValue = QtWidgets.QDoubleSpinBox(self.visualConfWidget)
        self.amplitudeMaxValue.setMinimumSize(QtCore.QSize(0, 30))
        self.amplitudeMaxValue.setMaximum(100000.0)
        self.amplitudeMaxValue.setObjectName("amplitudeMaxValue")
        self.gridLayout_13.addWidget(self.amplitudeMaxValue, 0, 0, 1, 1)
        self.amplitudeMaxMultiplier = QtWidgets.QSpinBox(self.visualConfWidget)
        self.amplitudeMaxMultiplier.setMinimumSize(QtCore.QSize(0, 30))
        self.amplitudeMaxMultiplier.setMinimum(-12)
        self.amplitudeMaxMultiplier.setMaximum(12)
        self.amplitudeMaxMultiplier.setSingleStep(3)
        self.amplitudeMaxMultiplier.setObjectName("amplitudeMaxMultiplier")
        self.gridLayout_13.addWidget(self.amplitudeMaxMultiplier, 0, 1, 1, 1)
        self.gridLayout_9.addLayout(self.gridLayout_13, 4, 2, 1, 1)
        self.gridLayout_12 = QtWidgets.QGridLayout()
        self.gridLayout_12.setObjectName("gridLayout_12")
        self.amplitudeMinValue = QtWidgets.QDoubleSpinBox(self.visualConfWidget)
        self.amplitudeMinValue.setMinimumSize(QtCore.QSize(0, 30))
        self.amplitudeMinValue.setMaximum(100000.0)
        self.amplitudeMinValue.setObjectName("amplitudeMinValue")
        self.gridLayout_12.addWidget(self.amplitudeMinValue, 0, 0, 1, 1)
        self.amplitudeMinMultiplier = QtWidgets.QSpinBox(self.visualConfWidget)
        self.amplitudeMinMultiplier.setMinimumSize(QtCore.QSize(0, 30))
        self.amplitudeMinMultiplier.setMinimum(-12)
        self.amplitudeMinMultiplier.setMaximum(12)
        self.amplitudeMinMultiplier.setSingleStep(3)
        self.amplitudeMinMultiplier.setObjectName("amplitudeMinMultiplier")
        self.gridLayout_12.addWidget(self.amplitudeMinMultiplier, 0, 1, 1, 1)
        self.gridLayout_9.addLayout(self.gridLayout_12, 4, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.visualConfWidget)
        ...
        self.gridLayout_11.addLayout(self.gridLayout_19, 5, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.erasePolinomialButton, 8, 0, 1, 3)
        self.currentPolLabel = QtWidgets.QLabel(self.widget)
        self.currentPolLabel.setMinimumSize(QtCore.QSize(0, 50))
        self.currentPolLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.currentPolLabel.setObjectName("currentPolLabel")
        self.gridLayout_7.addWidget(self.currentPolLabel, 3, 0, 1, 3)
        ...
        self.gridLayout_7.addWidget(self.addPolinomialButton, 7, 0, 1, 3)
        ...
        self.gridLayout_7.addWidget(self.ordenSpinbox, 1, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.coefMultiplier, 0, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.coefDoubleBox, 0, 1, 1, 1)
        self.addTermButton = QtWidgets.QPushButton(self.widget)
        self.addTermButton.setObjectName("addTermButton")
        self.gridLayout_7.addWidget(self.addTermButton, 2, 0, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Rango fase"))
        self.plotBodeButton.setText(_translate("MainWindow", "Graficar Bode"))
        self.label_2.setText(_translate("MainWindow", "Rango amplitud"))
        self.freqMode.setItemText(0, _translate("MainWindow", "Hz"))
        self.freqMode.setItemText(1, _translate("MainWindow", "Rad/seg"))

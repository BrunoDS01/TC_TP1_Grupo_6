...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.doubleSpinBox = QtWidgets.QDoubleSpinBox(self.ampFrecPage)
        self.doubleSpinBox.setMinimum(-360.0)
        self.doubleSpinBox.setMaximum(360.0)
        self.doubleSpinBox.setObjectName("doubleSpinBox")
        self.gridLayout_10.addWidget(self.doubleSpinBox, 3, 1, 1, 1)
        ...
        self.offsetSenMultiplier = QtWidgets.QSpinBox(self.ampFrecPage)
        self.offsetSenMultiplier.setObjectName("offsetSenMultiplier")
        self.gridLayout_10.addWidget(self.offsetSenMultiplier, 2, 2, 1, 1)
        self.label_13 = QtWidgets.QLabel(self.ampFrecPage)
        self.label_13.setObjectName("label_13")
        self.gridLayout_10.addWidget(self.label_13, 3, 0, 1, 1)
        self.offsetSen = QtWidgets.QDoubleSpinBox(self.ampFrecPage)
        self.offsetSen.setObjectName("offsetSen")
        self.gridLayout_10.addWidget(self.offsetSen, 2, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.frecSenDoubleBox, 0, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.frecuenciaSenMultiplicador, 0, 2, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.amplitudSenDoubleBox, 1, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.amplitudSenMultiplicador, 1, 2, 1, 1)
        ...
        self.addTemporalFunction = QtWidgets.QPushButton(self.widget_3)
        self.addTemporalFunction.setObjectName("addTemporalFunction")
        self.verticalLayout_7.addWidget(self.addTemporalFunction)
        ...
        self.gridLayout_13.addLayout(self.temporalResponsePlot, 0, 0, 2, 1)
        ...
        self.gridLayout_15.addWidget(self.csvButton, 4, 1, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.frequencyButton, 3, 0, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.temporalButton, 4, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_14.setText(_translate("MainWindow", "Duty Cycle (cuadrada)"))
        ...
        self.addTemporalFunction.setText(_translate("MainWindow", "Agregar señal temporal"))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_2.setMaximumSize(QtCore.QSize(225, 9999999))
        ...
        self.scatteredPlotButton = QtWidgets.QCheckBox(self.frame_2)
        self.scatteredPlotButton.setObjectName("scatteredPlotButton")
        self.gridLayout_15.addWidget(self.scatteredPlotButton, 8, 0, 1, 1)
        ...
        self.visualConfWidget.setMinimumSize(QtCore.QSize(100, 0))
        self.visualConfWidget.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.gridLayout_11.addWidget(self.eraseBodePlotsButton, 8, 0, 1, 1)
        self.plotBodeButton = QtWidgets.QPushButton(self.visualConfWidget)
        self.plotBodeButton.setObjectName("plotBodeButton")
        self.gridLayout_11.addWidget(self.plotBodeButton, 7, 0, 1, 1)
        ...
        self.ampYLabel.setMinimumSize(QtCore.QSize(100, 0))
        self.ampYLabel.setMaximumSize(QtCore.QSize(250, 16777215))
        ...
        self.gridCompleteButton = QtWidgets.QRadioButton(self.visualConfWidget)
        self.gridCompleteButton.setChecked(True)
        self.gridCompleteButton.setObjectName("gridCompleteButton")
        self.buttonGroup_5 = QtWidgets.QButtonGroup(MainWindow)
        self.buttonGroup_5.setObjectName("buttonGroup_5")
        self.buttonGroup_5.addButton(self.gridCompleteButton)
        self.gridLayout_14.addWidget(self.gridCompleteButton, 0, 0, 1, 1)
        self.gridSimpleButton = QtWidgets.QRadioButton(self.visualConfWidget)
        self.gridSimpleButton.setObjectName("gridSimpleButton")
        self.buttonGroup_5.addButton(self.gridSimpleButton)
        self.gridLayout_14.addWidget(self.gridSimpleButton, 1, 0, 1, 1)
        self.gridNoneButton = QtWidgets.QRadioButton(self.visualConfWidget)
        self.gridNoneButton.setObjectName("gridNoneButton")
        self.buttonGroup_5.addButton(self.gridNoneButton)
        self.gridLayout_14.addWidget(self.gridNoneButton, 2, 0, 1, 1)
        self.gridLayout_11.addLayout(self.gridLayout_14, 6, 0, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.minFreqValue, 5, 0, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.minFreqMultiplier, 5, 1, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.maxFreqValue, 7, 0, 1, 1)
        self.label_8 = QtWidgets.QLabel(self.visualConfWidget)
        self.label_8.setMinimumSize(QtCore.QSize(100, 0))
        self.label_8.setMaximumSize(QtCore.QSize(250, 15))
        ...
        self.gridLayout_19.addWidget(self.maxFreqMultiplier, 7, 1, 1, 1)
        self.freqMode = QtWidgets.QComboBox(self.visualConfWidget)
        self.freqMode.setMinimumSize(QtCore.QSize(100, 0))
        self.freqMode.setMaximumSize(QtCore.QSize(250, 16777215))
        self.freqMode.setObjectName("freqMode")
        self.freqMode.addItem("")
        self.freqMode.addItem("")
        self.gridLayout_19.addWidget(self.freqMode, 1, 0, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.freqAxisLogButton, 2, 0, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.freqAxisLinealButton, 2, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.scatteredPlotButton.setText(_translate("MainWindow", "Scattered plot"))
        ...
        self.phaseXLabel.setText(_translate("MainWindow", "Frecuencia [Hz]"))
        self.phaseYLabel.setText(_translate("MainWindow", "Fase [°]"))
        ...
        self.ampXLabel.setText(_translate("MainWindow", "Frecuencia [Hz]"))
        self.ampYLabel.setText(_translate("MainWindow", "|H(jw)| [dB]"))
        self.label_12.setText(_translate("MainWindow", "Amplitud X Label"))
        self.label_9.setText(_translate("MainWindow", "Amplitud Título"))
        self.gridCompleteButton.setText(_translate("MainWindow", "Grilla completa"))
        self.gridSimpleButton.setText(_translate("MainWindow", "Grilla simple"))
        self.gridNoneButton.setText(_translate("MainWindow", "Sin grilla"))
        ...
        self.label_16.setText(_translate("MainWindow", "Rango de tiempo señal ingresada [s]"))
        self.label_25.setText(_translate("MainWindow", "Y Label"))
        self.temporalYLabel.setText(_translate("MainWindow", "Tensión [V]"))
        self.temporalXLabel.setText(_translate("MainWindow", "Tiempo [s]"))
